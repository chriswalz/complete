...
* [example/compflag](./example/compflag): compflag shows how to use the github.com/chriswalz/complete/v2/compflag package to have auto bash completion for a defined set of flags.
